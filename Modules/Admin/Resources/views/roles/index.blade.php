...
@section('content')
    <div class="content-body">
        ...
        <p class="mb-2">
            يوفر أحد الأدوار إمكانية الوصول إلى القوائم والميزات المحددة مسبقًا بحيث يمكن للمسؤول ، بناءً على الدور المعين ،
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="d-flex align-items-end justify-content-center h-100">
                                <img src="{{ asset('') }}admin/images/illustration/faq-illustrations.svg"
