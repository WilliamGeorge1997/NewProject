...
@include('common::includes.datatable')
  ...
  {{-- <script src="{{asset('')}}js/admins/script.js"></script> --}}
    ...
    if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        var activation = '';
                        if(full['is_active'] ==0) activation ='Activate'; else activation = 'الغاء التفعيل';
                        return (
            ...
            buttons: [
                ...
                {
                    text: feather.icons['user-check'].toSvg({ class: 'font-small-4 me-50' }) + 'وظيفة',
                ...
                {
                    text: feather.icons['plus'].toSvg({ class: 'me-50 font-small-4' }) + 'اضافه',
        ...
        $('div.head-label').html('<h6 class="mb-0">الوظائف</h6>');
    }
