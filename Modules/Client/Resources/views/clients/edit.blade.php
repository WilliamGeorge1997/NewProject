    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">تعديل البيانات الخاصه بالعميل {{$client['name']}}</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{url('admin/clients/'.$client->id)}}" method="POST" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="fname-icon" class="form-control" value="{{$client['name']}}" name="name" placeholder="Name" />
                                        @error('name')
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" id="contact-icon" value="{{$client['phone']}}" class="form-control" name="phone" placeholder="Phone" />
                                        @error('phone')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                <div class="col-sm-3 text-center">
                                    <label class="col-form-label" for="contact-icon">اضافة رصيد (إن وجد)</label>
                                </div>
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="smartphone"></i></span>
                                        <input type="number" id="contact-icon" value="" class="form-control" name="balance" placeholder="balance" />
                                    </div>
                                </div>
                            </div>
                        </div>
