    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">انشاء خدمة فرعية جديدة</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{ url('admin/sub_services/') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" id="fname-icon" class="form-control" name="order"
                                            placeholder="order number" value="{{ old('order') }}" />
                                        @error('order')
                                            <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                <div class="col-sm-3 text-center">
                                    <label class="col-form-label" for="fname-icon"> المدة المتوقعة</label>
                                </div>
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <div class="mb-1">
                                <div class="form-check">
                                    <input type="checkbox" value="1" name="range" class="form-check-input"
                                        id="customCheck1" />
