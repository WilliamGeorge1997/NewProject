    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">تعديل البيانات الخاصه بالفئة {{ $category['title'] }}</h4>
            </div>
            <div class="card-body">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="fname-icon" value="{{$category['title']}}" class="form-control" name="title_ar" placeholder="العنوان" />
                                        @error('title_ar')
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" id="fname-icon" value="{{$category->getTranslations('title')['en']}}" class="form-control" name="title_en" placeholder="title" />
                                        @error('title_en')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" id="fname-icon" value="{{ $category->order }}"
                                            class="form-control" name="order" placeholder="order number" />
                                        @error('order')
                                            <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
